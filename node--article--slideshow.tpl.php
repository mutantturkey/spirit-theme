 ...
 <?php $location=strtolower(taxonomy_term_load($node->field_location['und'][0]["tid"])->name); ?>
  <img src="<?php print image_style_url("1500x750", $node->field_image['und'][0]["uri"])?>">
  <div class="slide-info">
    <a href="/node/<?php print $node->nid?>" class="fade">
  ...
  <img class="slide-location" src="/sites/all/themes/spirit/assets/images/<?print $location?>-red.svg" alt="<?php print $location?>" />
